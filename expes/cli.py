...
import torch
from expes.cli_plot import main as plot_main
...
def main():
    ...
    torch.save(ACC_TEST, _ensure_outdir("results/") / "mnist_acc_test.pt")
    torch.save(ACC_TRAIN, _ensure_outdir("results/") / "mnist_acc_train.pt")
