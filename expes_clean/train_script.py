...
def train_loop( 
    ...
    with mlflow.start_run():
        ...
        if method in ["pathcond", "dag_enorm", "pathcond_telep_schedule"]:
            ...
            if architecture in ["resnet", "resnet18", "full_conv", "full_conv_no_bn", "full_conv_no_bn_bias"]:
...
if __name__ == "__main__":
    train_loop(method="pathcond", architecture="resnet18_c", learning_rate=0.0001, epochs=2, seed=0, data="cifar10", experiment_name="test_marco")